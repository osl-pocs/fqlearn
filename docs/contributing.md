...
Transfer mass vizsolver could always use more documentation,
whether as part of the official Transfer mass vizsolver docs,
...
Ready to contribute? Here’s how to set up `py-masstranfer` for local development.

1.  Fork the `py-masstranfer` repo on GitHub.

2.  Clone your fork locally::

    $ git clone git@github.com:your_name_here/py-masstranfer.git

3.  Install your local copy into a virtualenv. Assuming you have
    virtualenvwrapper installed, this is how you set up your fork for
    local development::

    $ mkvirtualenv py-masstranfer
    $ cd py-masstranfer/
